                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-700">
                            @if ($driver->validity_cnh && $driver->cnh_will_expire_soon)
                                <span class="inline-block bg-orange-100 text-orange-700 text-xs px-4 py-1 rounded-full font-semibold">
                            ...
                            @else
                                <span class="inline-block bg-gray-100 text-gray-300 text-xs px-4 py-1 rounded-full">
